...
;--------------------------------------------------
;基本的には原作準拠。
;本編開始前の一人旅中にお空に迷い込んだ設定。
;オーナーは男あなた前提。
;セクハラ反応パターンは3:嫌悪
;下半身体型は細身以下
;陥落による奥義変化で二丁閃術を使うのでもう一丁のリボルバーを得る展開を書きたい。向日葵三十八式を解析して反転コピーした水仙八十三式とか。
;口調補足。誰が相手でも敬語を使わない。
