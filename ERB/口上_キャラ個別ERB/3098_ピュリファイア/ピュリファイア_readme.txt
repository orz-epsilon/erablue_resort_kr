...
;
;◯参考資料
;  カワイイスパイスの性欲処理-1『ホムンクルスたちと乱交セックス』
;  https://www.pixiv.net/novel/show.php?id=23341706
;  ……に、ちょっとだけ出てくる。タチレズハーレム構築済み。
;  別世界線だとカワイイスパイスに性のなんたるかを叩き込まれているが、
;  メーカネース・ナーヴィスにおいては勝手にハーレムクイーンとなった。
;  
;〇性格/陥落前/前提
;  カワイイスパイスに明らかな肉欲を向けている。
;  徹底的な男嫌い。
;
;〇性格/陥落後
;  気丈なところはそのまま、オーナーに対して気を許す。
;  オーナーが[オトコ]であれば異性愛を取得しているものと思うので、妊娠をせがませてもよい。
;
;〇身体について
;  長身絶壁スレンダー。
;
...
;〇文章規範
;・前提
;　オーナーは[オトコ]あなたで、ピュリファイアは女（非[オトコ]）とする。
;・地の文/マスターの言動
;  丁寧に扱ってやってくれ。これでも心に傷を抱えている。
;  ピュリファイアの心情描写は彼女の動作によって補完すること。
;・喘ぎ
;　余程のことがなければ控えめ。快楽刻印3まで届きそうならオホ声もあり。
;・ハートマーク
;　彩り程度に。声出せないくらいの強度だったらダッシュとハートマークだけで表現してもよし。
;
;・コンパチ
